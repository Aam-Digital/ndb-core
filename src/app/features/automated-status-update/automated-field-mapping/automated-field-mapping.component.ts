...
export class AutomatedFieldMappingComponent<E extends Entity> implements OnInit {
 ...
 async ngOnInit(): Promise<void> {
    console.log( await this.entityMapperService.loadType( this.entitiesToSetAutomateRule),"okay");
