...
export class FormDialogService {
  ...
  openDialog<T extends ShowsEntity>(entityDetailsComponent: ComponentType<T>, entity: any): MatDialogRef<T> {
    const dialogRef = this.dialog.open(entityDetailsComponent, { width: '80%' });
