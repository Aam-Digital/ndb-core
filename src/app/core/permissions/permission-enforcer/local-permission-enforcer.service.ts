...
/**
 * Checks whether the relevant rules for the current user changed and reacts
 * accordingly. Used for session types with a local database (`synced`/`local`/
 * `mock`) - see {@link PermissionEnforcerService}.
 *
