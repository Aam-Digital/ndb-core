 ...
 * A default permission config is also generated which can be adjusted here for testing.
 */
@Injectable()
export class DemoUserGeneratorService extends DemoDataGenerator<
  User | Config<DatabaseRules>
> {
   ...
   */
  public generateEntities(): (User | Config<DatabaseRules>)[] {
    ...
    const config = new Config(Config.PERMISSION_KEY, rules);
