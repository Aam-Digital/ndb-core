...
/*
 * Temporarily disabled: flaky drag-and-drop interactions require further stabilization.
test("Create new field by dragging and save field details", async ({ page }) => {
  // ...implementation intentionally commented out...
});
*/
