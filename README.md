...
| **CodeRabbit** (GitHub)      | Automated PR reviews — configured via `.coderabbit.yaml`. Add the label **"Ready for AI Review"** to trigger a review (works in draft mode too; removing the label stops further auto-reviews). |
